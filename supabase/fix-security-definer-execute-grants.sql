...
revoke execute on function public.try_spend_user_monthly_credit(uuid, date, integer, integer)
  from public, anon, authenticated;
revoke execute on function public.refund_user_monthly_credit(uuid, date, integer, integer, integer, integer)
  from public, anon, authenticated;

revoke execute on function public.check_api_rate_limit(text, text, integer, integer)
  from public, anon, authenticated;
revoke execute on function public.add_user_bonus_credits(uuid, date, integer, integer)
  from public, anon, authenticated;
revoke execute on function public.migrate_guest_credits_to_user(text, uuid, date, integer)
  from public, anon, authenticated;
...
grant execute on function public.try_spend_user_monthly_credit(uuid, date, integer, integer)
  to service_role;
grant execute on function public.refund_user_monthly_credit(uuid, date, integer, integer, integer, integer)
  to service_role;

grant execute on function public.check_api_rate_limit(text, text, integer, integer)
  to service_role;
grant execute on function public.add_user_bonus_credits(uuid, date, integer, integer)
  to service_role;
grant execute on function public.migrate_guest_credits_to_user(text, uuid, date, integer)
  to service_role;
